...
export default class MusicInput extends EventTarget {
    ...
    registerOnScreenKeyboard(el) {
        el.addEventListener('press', (e) => { this.notifyPressedKey(Note.fromPianoKey(e.detail.key)); });
        // Do I need to unregister keyboards, when navigating away from practice components, or do they get garbage-collected?
    }
